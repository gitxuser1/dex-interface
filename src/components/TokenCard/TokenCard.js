        ...
        <div>
          ...
          <div className="Home-token-card-option-info">
            <div className="Home-token-card-option-title">
              <Trans>
              DEX is the utility and governance token. Accrues 30% and 27% of V1 and V2 markets generated fees,
                respectively.
              </Trans>
            </div>
      ...
      <div className="Home-token-card-option">
        <div>
          ...
          <div className="Home-token-card-option-info">
            <div className="Home-token-card-option-title">
              <Trans>
                GM is the liquidity provider token for DEX V2 markets. Accrues 63% of the V2 markets generated fees.
              </Trans>
            </div>
          </div>
      ...
      <div className="Home-token-card-option">
        <div>
          ...
          <div className="Home-token-card-option-info">
            <div className="Home-token-card-option-title">
              <Trans>
                GLP is the liquidity provider token for DEX V1 markets. Accrues 70% of the V1 markets generated fees.
              </Trans>
