...
function NoJob() {
  return (
    <Card title={t`No open positions at DEX currently`}>
      <div className="body-para">
        <p className="subheading">
          <Trans>
            DEX is not actively looking for new hires at the moment. However, if you think you can contribute to the
...
//     <ul>
//       <li>Work closely with the DEX team on the DEX front-end website.</li>
...
//       </ul>
//       <p>The salary is 60,000 to 120,000 USD + 1,000 to 3,000 DEX a year.</p>
